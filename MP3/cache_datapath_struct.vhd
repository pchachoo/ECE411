...
ARCHITECTURE struct OF Cache_Datapath IS
   ...
   FOR ALL : AddressCombiner USE ENTITY ece411.AddressCombiner;
   ...
   FOR ALL : DelayBlock5ns USE ENTITY ece411.DelayBlock5ns;
   FOR ALL : GenMResp USE ENTITY ece411.GenMResp;
...
BEGIN
   ...
   aAddressCombiner : AddressCombiner
      PORT MAP (
         DelTag  => DelTag,
         CombAdd => CombAdd,
         INDEX   => INDEX
      );
   aAdSplitter : AddressSplitter
      PORT MAP (
         Offset4 => Offset4,
         Index3  => Index3,
         Tag9    => Tag9,
